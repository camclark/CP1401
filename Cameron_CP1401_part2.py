...
def orderTicket(userName):
    ...
    #gets information on their choices
...
def main():
    ...
    while not exitProgram:
        userInput = input("Tropic Airlines Ticket Ordering System: \n(I)nstructions \n(O)rder ticket \n(E)xit \n")
        ...
        if userInput == "o":
            ...
            if ticketCostLength ==1:
                ...
                for i in range(0, len(ticketCost)):
                    displayCost = "${:,.2f}".format(ticketCost[i])
                    print("Ticket " + str(i+1) + " " + displayCost)
